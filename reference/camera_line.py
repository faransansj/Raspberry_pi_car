...
def detect_edges(frame):
    lower_white = np.array([100, 100, 100], dtype = "uint8") # lower limit of white color
    upper_white = np.array([255, 255, 255], dtype="uint8") # upper limit of white color
    mask = cv2.inRange(hsv,lower_white,upper_white) # this mask will filter out everything but white
